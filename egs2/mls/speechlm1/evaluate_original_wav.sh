...
for lang in ${langs[@]}; do
    for dset in ${dsets[@]}; do
        log "Evaluate $lang $dset"
    
        gen_dir=dump_16000/raw_tts_emilia_ESPnet_espnet_mls-multi_soundstream_16k/emilia_${lang}_${dset}/waveform
        ref_dir=dump_16000/raw_tts_emilia_ESPnet_espnet_mls-multi_soundstream_16k/emilia_${lang}_${dset}
        key_file=dump_16000/raw_tts_emilia_ESPnet_espnet_mls-multi_soundstream_16k/emilia_${lang}_${dset}/key_file
        if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
            if ${eval_wer}; then
                ...
                ./scripts/utils/evaluate_asr.sh \
                    ...
                    ${gen_dir}/wav_test.scp ${gen_dir}/scoring/eval_wer
            ...
            for eval_item in mos spk; do
                ...
                if ${!eval_flag}; then
                    ...
                    if [ ${eval_item} == "mos" ]; then
                        pred_file=${gen_dir}/wav_test.scp
